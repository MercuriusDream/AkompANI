...
function toSlug(input: string): string {
  ...
  return normalized || "voyager-elysia-worker";
}
      ...
      prompts: [
        {
          id: "invoke_flow",
          label: "Invoke Flow",
          description: "Forward current request payload to Voyager flow webhook.",
          endpoint: "/invoke",
          method: "POST",
        },
      ],
...
<html lang="en">
  ...
  <body>
    <main class="shell">
      ...
      <section class="card">
        <h2>Invoke Flow</h2>
        <p>Payload is forwarded to <code>/invoke</code>, which proxies to Voyager webhook.</p>
